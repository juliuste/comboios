...
const buildDate = (day, time, timezone) => moment.tz(`${day} ${time}`, 'DD.MM.YYYY HH:mm', timezone)

module.exports = { operator, createStation, buildTripId, splitTripId, uicCodeFromId, idToUicId, timezoneAndCountry, buildDate }
